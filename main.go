...
import (
	...
	"github.com/andrewhsu/external-dns/controller"
	"github.com/andrewhsu/external-dns/endpoint"
	"github.com/andrewhsu/external-dns/pkg/apis/externaldns"
	"github.com/andrewhsu/external-dns/pkg/apis/externaldns/validation"
	"github.com/andrewhsu/external-dns/plan"
	"github.com/andrewhsu/external-dns/provider"
	"github.com/andrewhsu/external-dns/provider/akamai"
	"github.com/andrewhsu/external-dns/provider/alibabacloud"
	"github.com/andrewhsu/external-dns/provider/aws"
	"github.com/andrewhsu/external-dns/provider/awssd"
	"github.com/andrewhsu/external-dns/provider/azure"
	"github.com/andrewhsu/external-dns/provider/cloudflare"
	"github.com/andrewhsu/external-dns/provider/coredns"
	"github.com/andrewhsu/external-dns/provider/designate"
	"github.com/andrewhsu/external-dns/provider/digitalocean"
	"github.com/andrewhsu/external-dns/provider/dnsimple"
	"github.com/andrewhsu/external-dns/provider/dyn"
	"github.com/andrewhsu/external-dns/provider/exoscale"
	"github.com/andrewhsu/external-dns/provider/google"
	"github.com/andrewhsu/external-dns/provider/infoblox"
	"github.com/andrewhsu/external-dns/provider/inmemory"
	"github.com/andrewhsu/external-dns/provider/linode"
	"github.com/andrewhsu/external-dns/provider/ns1"
	"github.com/andrewhsu/external-dns/provider/oci"
	"github.com/andrewhsu/external-dns/provider/ovh"
	"github.com/andrewhsu/external-dns/provider/pdns"
	"github.com/andrewhsu/external-dns/provider/rcode0"
	"github.com/andrewhsu/external-dns/provider/rdns"
	"github.com/andrewhsu/external-dns/provider/rfc2136"
	"github.com/andrewhsu/external-dns/provider/scaleway"
	"github.com/andrewhsu/external-dns/provider/transip"
	"github.com/andrewhsu/external-dns/provider/ultradns"
	"github.com/andrewhsu/external-dns/provider/vinyldns"
	"github.com/andrewhsu/external-dns/provider/vultr"
	"github.com/andrewhsu/external-dns/registry"
