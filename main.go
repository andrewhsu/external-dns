...
import (
	...
	"github.com/redpanda-data/external-dns/controller"
	"github.com/redpanda-data/external-dns/endpoint"
	"github.com/redpanda-data/external-dns/pkg/apis/externaldns"
	"github.com/redpanda-data/external-dns/pkg/apis/externaldns/validation"
	"github.com/redpanda-data/external-dns/plan"
	"github.com/redpanda-data/external-dns/provider"
	"github.com/redpanda-data/external-dns/provider/akamai"
	"github.com/redpanda-data/external-dns/provider/alibabacloud"
	"github.com/redpanda-data/external-dns/provider/aws"
	"github.com/redpanda-data/external-dns/provider/awssd"
	"github.com/redpanda-data/external-dns/provider/azure"
	"github.com/redpanda-data/external-dns/provider/cloudflare"
	"github.com/redpanda-data/external-dns/provider/coredns"
	"github.com/redpanda-data/external-dns/provider/designate"
	"github.com/redpanda-data/external-dns/provider/digitalocean"
	"github.com/redpanda-data/external-dns/provider/dnsimple"
	"github.com/redpanda-data/external-dns/provider/dyn"
	"github.com/redpanda-data/external-dns/provider/exoscale"
	"github.com/redpanda-data/external-dns/provider/google"
	"github.com/redpanda-data/external-dns/provider/infoblox"
	"github.com/redpanda-data/external-dns/provider/inmemory"
	"github.com/redpanda-data/external-dns/provider/linode"
	"github.com/redpanda-data/external-dns/provider/ns1"
	"github.com/redpanda-data/external-dns/provider/oci"
	"github.com/redpanda-data/external-dns/provider/ovh"
	"github.com/redpanda-data/external-dns/provider/pdns"
	"github.com/redpanda-data/external-dns/provider/rcode0"
	"github.com/redpanda-data/external-dns/provider/rdns"
	"github.com/redpanda-data/external-dns/provider/rfc2136"
	"github.com/redpanda-data/external-dns/provider/scaleway"
	"github.com/redpanda-data/external-dns/provider/transip"
	"github.com/redpanda-data/external-dns/provider/ultradns"
	"github.com/redpanda-data/external-dns/provider/vinyldns"
	"github.com/redpanda-data/external-dns/provider/vultr"
	"github.com/redpanda-data/external-dns/registry"
	"github.com/redpanda-data/external-dns/source"
)
